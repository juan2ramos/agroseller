...
@section('content')
            ...
            <g id="Product-detail" transform="translate(-1186.000000, -345.000000)" fill="#C5D257">
                <g id="price" transform="translate(744.000000, 342.000000)">
                    <g id="leaves" transform="translate(436.000000, 2.000000)">
                        <g id="Page-1"
                           transform="translate(14.500000, 14.000000) rotate(-35.000000) translate(-14.500000, -14.000000) translate(4.500000, 4.000000)">
                            <path d="M13.7751613,5.51032258 L18.9741935,0.312580645 C18.0606452,0.452258065 17.0967742,0.466129032 16.2248387,0.574516129 C15.4812903,0.66516129 14.7303226,0.77 14.0109677,0.982903226 C13.9451613,1.05483871 13.9867742,1.44903226 13.9819355,1.54096774 C13.9125806,2.86419355 13.8432258,4.18709677 13.7751613,5.51032258 L13.7751613,5.51032258 Z"
                                  id="Fill-1"></path>
                            <path d="M12.8616129,1.22612903 C12.36,1.29903226 9.42548387,1.78677419 9.41032258,2.36516129 C9.38870968,3.24483871 9.36612903,4.12419355 9.34354839,5.00516129 C9.31064516,6.26645161 9.27677419,7.52774194 9.24032258,8.78903226 C9.23516129,8.95548387 9.12806452,9.66870968 9.10903226,10.1790323 L12.6474194,6.64064516 C12.7193548,4.83483871 12.7896774,3.03064516 12.8616129,1.22612903 L12.8616129,1.22612903 Z"
                                  id="Fill-2"></path>
    ...
    <section class="ProductDetail row">
        <article class="smaller-12 to-large">
            ...
            <nav class="ProductDetail-network row between">
                <div class="social-share">
                    ...
                    <div class="fb-share-button"
                         data-href="{{route('productDetail', ['slug' => $product->slug, 'id' => $product->id])}}"
                ...
                <div class="social-share">
                    ...
                    <a href="https://twitter.com/share" class="twitter-share-button"
                       data-url="{{route('productDetail', ['slug' => $product->slug, 'id' => $product->id])}}"
                       data-text="{!!$product->name!!}" data-via="twitter-agroseller" data-lang="es" data-size="large"
                       data-dnt="true">Twittear</a>
                </div>
            </nav>
        </article>
        <article class="smaller-6 col-6 ProductDetail-thumbnail from-large">
            <div class="row between owl-carousel" id="sync2">
                @foreach($product->productFiles as $file)
                    @if($file->extension != 'pdf')
                        <figure class="item" class="smaller3 col-3">
